...
const MainHeader = () => {
  return (
    <main className="bg-[url('../../public/assets/imgs/bg-reposteria.jpg')] w-full h-[93vh] bg-no-repeat bg-cover relative">
      <div className='h-full bg-gradient-to-t from-white from-5%'>
        <div className='flex justify-center items-center h-full'>
          <div className='md:h-max md:p-0 w-max md:max-w-5xl mt-24 md:mt-20'>
