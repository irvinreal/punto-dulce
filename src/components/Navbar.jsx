    ...
    return (
        <div className="fixed top-0 left-0 z-50 w-screen">
            <nav
                className={
                    open
                        ? "bg-white text-sm h-screen sm:h-12 relative"
                        : "h-12 bg-white relative"
                }
            >
                    ...
                    <Link href={"/"}>
                        <div className="flex items-center">
                            <div className="relative w-20 h-20 me-1 ms-16 bg-white rounded-full">
                                ...
                                />
                                <span className="text-gray-500 w-32 block text-center text-sm  absolute top-7 -left-6 tracking-wider">
                                    Punto Dulce
                                </span>
                            </div>
                ...
                >
                    ...
                    >
                        <span
                            className={
                                open ? "hidden" : "inline-block absolute"
                            }
                        >
                            <svg
                        ...
                        <span
                            className={
                                open
                                    ? "hidden"
                                    : "inline-block animate-ping focus:animate-none hover:animate-none"
                            }
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <ul
                    className={
                        open
                            ...
                            : "hidden md:flex h-full justify-center items-center gap-8"
                    }
                >
                    ...
                    <li className="flex justify-center">
                        ...
                        >
                            ...
                            <svg
                                ...
                                className={
                                    pathname.startsWith("/crear-pedido")
                                        ? "bi bi-bag-fill md:shadow"
                                        : "bi bi-bag-fill trasition ease-in-out duration-500 md:shadow md:opacity-0 md:-translate-x-3 md:group-hover/item:opacity-100 group-hover/item:translate-x-0"
                                }
